...
class Main {
    static Book[] bookList = {
            new Book(1, "Pride and Prejudice", "Jane Austen", "Romance"),
            new Book(2, "1984", "George Orwell", "Science Fiction"),
            new Book(3, "The Da Vinci Code", "Dan Brown", "Mystery Thriller")
    };
